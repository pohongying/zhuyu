...
import com.luoyi.implatform.config.JwtProperties;
...
import com.luoyi.implatform.vo.OnlineTerminalVO;
import com.luoyi.implatform.vo.UserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LoginVO login(LoginDTO dto) {
        ...
        // 登录时生成token:id+username+terminal
