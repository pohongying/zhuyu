...
public class FastDFSUtil {
     ...
     * @param response
     */
    public void downloadFile(String filepath, HttpServletResponse response) throws FastDFSException, IOException {
     ...
     * @param os       输出流
     */
    public void downloadFile(String filepath, OutputStream os) throws FastDFSException, IOException {
     ...
     */
    public void downloadFile(String filepath, String filename, HttpServletResponse response) throws FastDFSException, IOException {
     ...
     * @param response HttpServletResponse
     */
    public void download(String filepath, String filename, OutputStream os, HttpServletResponse response) throws FastDFSException, IOException {
        if (StringUtils.isBlank(filepath)) {
            throw new FastDFSException(ErrorCode.FILE_PATH_ISNULL.CODE, ErrorCode.FILE_PATH_ISNULL.MESSAGE);
        }
     ...
     * @throws FastDFSException
     */
    public byte[] download(String filepath) throws FastDFSException, IOException {
        if (StringUtils.isBlank(filepath)) {
            throw new FastDFSException(ErrorCode.FILE_PATH_ISNULL.CODE, ErrorCode.FILE_PATH_ISNULL.MESSAGE);
        }
     ...
     */
    public int deleteFile(String filepath) throws FastDFSException, IOException {
        if (StringUtils.isBlank(filepath)) {
            throw new FastDFSException(ErrorCode.FILE_PATH_ISNULL.CODE, ErrorCode.FILE_PATH_ISNULL.MESSAGE);
        }
        /*
     ...
     * </pre>
     */
    public Map<String, Object> getFileInfo(String filepath) throws FastDFSException, IOException {
        /*      *//**
         * 获取tracker
         *//*
        TrackerClient trackerClient = new TrackerClient();
     ...
     * @return 文件描述信息
     */
    public Map<String, Object> getFileDescriptions(String filepath) throws FastDFSException, IOException {
     ...
     * @return 文件名称
     */
    public String getOriginalFilename(String filepath) throws FastDFSException, IOException {
