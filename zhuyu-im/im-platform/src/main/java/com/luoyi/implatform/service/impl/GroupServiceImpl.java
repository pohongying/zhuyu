...
import com.luoyi.imcommon.util.CommaTextUtils;
...
import com.luoyi.implatform.entity.Group;
import com.luoyi.implatform.entity.GroupMember;
...
import com.luoyi.implatform.mapper.GroupMapper;
import com.luoyi.implatform.mapper.GroupMessageMapper;
import com.luoyi.implatform.service.FriendService;
import com.luoyi.implatform.service.GroupMemberService;
import com.luoyi.implatform.service.GroupService;
...
import com.luoyi.implatform.vo.GroupInviteVO;
import com.luoyi.implatform.vo.GroupMemberVO;
import com.luoyi.implatform.vo.GroupMessageVO;
import com.luoyi.implatform.vo.GroupVO;

@Slf4j
@Service
@RequiredArgsConstructor   // todo 构造注入
...
public class GroupServiceImpl extends ServiceImpl<GroupMapper, Group> implements GroupService {
    ...
    public void quitGroup(Long groupId) {
        ...
        // 推送退出群聊提示
        this.sendTipMessage(groupId, userIds, "您已退出群聊");
    ...
    public void kickGroup(Long groupId, Long userId) {
        ...
        redisTemplate.opsForHash().delete(key, userId.toString());
        // 推送踢出群聊提示
        this.sendTipMessage(groupId, Collections.singletonList(userId), "您已被移出群聊");
    ...
    private void sendTipMessage(Long groupId, List<Long> recvIds, String content) {
        ...
        // 推送
        GroupMessageVO msgInfo = BeanUtils.copyProperties(message, GroupMessageVO.class); // dto消息内容复制vo
