...
import com.luoyi.implatform.mapper.GroupMemberMapper;
import com.luoyi.implatform.service.GroupMemberService;
import com.luoyi.implatform.util.DateTimeUtils;
...
public class GroupMemberServiceImpl extends ServiceImpl<GroupMemberMapper, GroupMember> implements GroupMemberService {
    @CacheEvict(key = "#member.getGroupId()")  // todo 保证数据的一致性
    @Override
    ...
    public List<GroupMember> findQuitInMonth(Long userId) {
        // todo 取当前时间往前推一个月的时间点，存储在monthTime变量中
